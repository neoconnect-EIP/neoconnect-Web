                    ...
                    this.state.userData ?
                        <Grid container justify="center">
                            ...
                            <Grid container justify="center" alignItems="center">
                                <Avatar alt="Avatar not found" src={this.state.userData.userPicture ? this.state.userData.userPicture.imageData : ""} style={{width: "180px", height: "180px", position: "absolute", backgroundColor: "white", marginTop: "24rem", zIndex: "10", boxShadow: "0 0 10px"}}/>
                            </Grid>
                                    ...
                                    <Grid item xs={12}>
                                        <Grid container justify="center">
                                            <Grid item xs={12} md={6} style={{textAlign: "center"}}>
                                                <h1>Note</h1>
                                                <h1 style={{marginTop: "2rem", fontSize: "6.25rem", color: "black"}}>`${this.state.mark}/5`</h1>
                                            </Grid>
