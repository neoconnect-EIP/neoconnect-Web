        ...
        return (
            <Grid className="about-faq" className="shopBgX" container style={{backdropFilter: "blur(8px) brightness(50%)"}}>
                ...
                <Grid item xs={6} style={{paddingLeft: "50px", paddingRight: "50px", marginBottom: "30px"}}>
                    ...
                    <p style={{color: "white"}}> Neoconnect est une plateforme de mise en relation entre les influenceurs et les marques.
                ...
                <Grid item xs={6} style={{paddingLeft: "50px", paddingRight: "50px", marginBottom: "30px"}}>
                    ...
                    <p style={{color: "white"}}> Est considérer comme neo influenceurs toute personnes éyant au minimum 10.000 followers sur un des reseaux sociaux suivant: <br/>
                    <ul>
                        <li>Instagram</li>
                        <li>Twitter</li>
                        <li>Facebook</li>
                ...
                <Grid item xs={6} style={{paddingLeft: "50px", paddingRight: "50px", marginBottom: "30px"}}>
                    ...
                    <p style={{color: "white"}}> Si vous êtes un influenceur, oui c'est totalement gratuit !<br/>
                ...
                <Grid item xs={6} style={{paddingLeft: "50px", paddingRight: "50px", marginBottom: "30px"}}>
                    ...
                    <p style={{color: "white"}}> En tant qu'influenceur, utiliser Neoconnect peut vous permettre de gagner
                ...
                <Grid item xs={6} style={{paddingLeft: "50px", paddingRight: "50px", marginBottom: "30px"}}>
                    ...
                    <p style={{color: "white"}}> Notre platforme contrairement aux autres services de mise en relation influenceurs/commerces, s'adresse à une clientel plus accessible.<br/>
                ...
                <Grid item xs={6} style={{paddingLeft: "50px", paddingRight: "50px", marginBottom: "30px"}}>
                    ...
                    <p style={{color: "white"}}>L'ensemble de nos collaborateurs se trouve dans la rubrique "Nos collaborateurs"</p>
                </Grid>
            </Grid>
        );
    }
